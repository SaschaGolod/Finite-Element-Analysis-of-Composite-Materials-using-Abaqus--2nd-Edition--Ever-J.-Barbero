""" Script to generate Example 6.5-parametric """

# make sure the Work Directory is OK
import os
os.chdir(r'C:\Documents\Abaqus\Chapter_6\Ex_6.5')
...
mdb.saveAs(pathName='C:/Documents/Abaqus/Chapter_6/Ex_6.5/Ex-6-5.cae')
...
mdb.models['Model-1'].Part(dimensionality=THREE_D, name='Part-1', type=
    DEFORMABLE_BODY)
mdb.models['Model-1'].parts['Part-1'].BaseSolidExtrude(depth=a_3, sketch=
    mdb.models['Model-1'].sketches['__profile__'])
del mdb.models['Model-1'].sketches['__profile__']

# create datum planes to later partition
mdb.models['Model-1'].parts['Part-1'].DatumPlaneByPrincipalPlane(offset=1*t_k, 
    principalPlane=XYPLANE)
mdb.models['Model-1'].parts['Part-1'].DatumPlaneByPrincipalPlane(offset=2*t_k, 
    principalPlane=XYPLANE)
mdb.models['Model-1'].parts['Part-1'].DatumPlaneByPrincipalPlane(offset=3*t_k, 
    principalPlane=XYPLANE)
...
mdb.models['Model-1'].parts['Part-1'].MaterialOrientation(
    ...
    theta_1, axis=AXIS_3, fieldName='', localCsys=
...
mdb.models['Model-1'].DisplacementBC(amplitude=UNSET, createStepName='Step-1', 
    ...
    a_2, u2=0.0, u3=UNSET, ur1=UNSET, ur2=UNSET, ur3=UNSET)
...
mdb.models['Model-1'].Tie(adjust=OFF, master=Region(
    ...
    mask=('[#c050 ]', ), )), name='Constraint-1', positionTolerance=10.0, 
